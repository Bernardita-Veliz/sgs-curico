...
<?php
 if(isset($_POST['add_cat'])){
   $req_field = array('cliente-name', 'cliente-direccion', 'cliente-dni', 'cliente-celular', 'cliente-estado' );
   ...
   if(empty($errors)){
      ...
      $query .=" name, direccion, dni, celular, estado";
      $query .=") VALUES (";
      $query .=" '{$cat_name}', '{$cat_dirrecion}', '{$cat_dni}', '{$cat_celular}', '{$cat_estado}'";
      $query .=")";
      $query .=" ON DUPLICATE KEY UPDATE name='{$cat_name}'";
      $sql  = "INSERT INTO clientes (name, direccion, dni, celular, estado)";
      $sql .= " VALUES ('{$cat_name}', '{$cat_direccion}', '{$cat_dni}', '{$cat_celular}', '{$cat_estado}')";
      if($db->query($sql)){
        $session->msg("s", "Cliente agregada exitosamente.");
        redirect('administrar_cliente.php',false);
      } else {
          ...
          <div class="col-md-5">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form method="post" action="administrar_cliente.php">
                  <div class="form-group">
                      <input type="text" class="form-control" name="cliente-name" placeholder="Nombre del cliente" ><br>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <input type="text" class="form-control" name="cliente-dni" placeholder="Dni" required>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="cliente-celular" value="<?php echo remove_junk($clientes['celular']);?>">
                              </div>
                          </div>
                      </div>
                      <div class="col-md-4">
                          <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <select class="form-control" name="cliente-estado" placeholder="estado" value="<?php echo remove_junk($clientes['estado']);?>" required>
                  ...
                  <tbody>
                    <?php foreach ($all_clientes as $cat):?>
                      <tr>
                          ...
                          <td><?php echo remove_junk(ucfirst($cat['dni'])); ?></td>
                          <td><?php echo remove_junk(ucfirst($cat['celular'])); ?></td>
                          <td><?php echo remove_junk(ucfirst($cat['estado'])); ?></td>
