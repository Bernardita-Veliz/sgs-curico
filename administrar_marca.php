...
<?php
 if(isset($_POST['add_cat'])){
   $req_field = array('categorie-name', 'categorie-estado');
   ...
   if(empty($errors)){
      ...
      $query .=" name, estado";
      $query .=") VALUES (";
      $query .=" '{$cat_name}', '{$cat_estado}'";
      $query .=")";
      $query .=" ON DUPLICATE KEY UPDATE name='{$cat_name}'";
      $sql  = "INSERT INTO categories (name, estado)";
      $sql .= " VALUES ('{$cat_name}', '{$cat_estado}')";
      if($db->query($sql)){
          ...
          <div class="col-md-5">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form method="post" action="administrar_marca.php">
                  <div class="form-group">
                      <input type="text" class="form-control" name="categorie-name" placeholder="Nombre de la marca" required><br>
                      <select class="form-control" name="categorie-estado" placeholder="estado"  required>
                        <option value="Vigente">Vigente</option>
                        <option value="No Vigente">No Vigente</option>                              
                      </select><br>
                  </div>
                  <button type="submit" name="add_cat" class="btn btn-primary">Agregar Marca</button>
                </form>
              </div>
            </div>
          </div><br><br>
                    ...
                    <?php foreach ($all_categories as $cat):?>
                      <tr>
                          ...
                          <td class="text-center">
                            <div class="btn-group">
                              <a href="editar_marca.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="Editar">
                                <span class="glyphicon glyphicon-edit"></span>
                              </a>
                              <a href="delete_marca.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-danger" data-toggle="tooltip" title="Eliminar">
