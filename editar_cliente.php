...
if(isset($_POST['edit_cat'])){
  $req_field = array('cliente-name');
  $req_field = array('cliente-direccion');
  $req_field = array('cliente-dni');
  $req_field = array('cliente-celular');
  $req_field = array('cliente-estado');
  validate_fields($req_field);
  $cat_name = remove_junk($db->escape($_POST['cliente-name']));
  $cat_direccion = remove_junk($db->escape($_POST['cliente-direccion']));
  $cat_dni = remove_junk($db->escape($_POST['cliente-dni']));
  $cat_celular = remove_junk($db->escape($_POST['cliente-celular']));
  $cat_estado = remove_junk($db->escape($_POST['cliente-estado']));
  if(empty($errors)){
        $sql = "UPDATE clientes SET name='{$cat_name}'";
        $sql = "UPDATE clientes SET direccion='{$cat_direccion}'";
        $sql = "UPDATE clientes SET dni='{$cat_dni}'";
        $sql = "UPDATE clientes SET celular='{$cat_celular}'";
        $sql = "UPDATE clientes SET estado='{$cat_estado}'";
                        ...
                        <div class="panel-body">
                            <form method="post" action="editar_marca.php?id=<?php echo (int)$categorie['id'];?>">
                                <div class="form-group">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="cliente-name" placeholder="Nombre del cliente" value="<?php echo remove_junk(ucfirst($cliente['name']));?>"> <br>
                                        <label for="qty">Dirección</label>
                                        <input type="text" class="form-control" name="cliente-direccion" placeholder="Direccion" value="<?php echo remove_junk($cliente['direccion']);?>" ><br>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label for="qty">Dni</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="cliente-dni" placeholder="Dni" value="<?php echo remove_junk($cliente['dni']);?>"  required>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" class="form-control" name="cliente-celular" value="<?php echo remove_junk($cliente['celular']);?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" name="cliente-estado" placeholder="estado" value="<?php echo remove_junk($cliente['estado']);?>" required>
